...
const config = {
    ...
    tokenIssuer: 'https://your-identity-provider.com', // Replace with your issuer URL (duplicate of value in setting above) (e.g., https://your-next-identity-provider.com)
